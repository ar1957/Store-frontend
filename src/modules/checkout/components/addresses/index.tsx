...
const Addresses = ({
  ...
  useEffect(() => {
    try {
      ...
      setEligibilityState(raw ? JSON.parse(raw)?.state || null : null)
    } catch {}
  }, [])
                ...
                <div className="flex items-start gap-x-1 w-full">
                  ...
                  >
                    ...
                    <Text className="txt-medium text-ui-fg-subtle">
                      ...
                      {(eligibilityState || cart.shipping_address.province) && `, ${eligibilityState || cart.shipping_address.province}`}{" "}
                      {cart.shipping_address.postal_code}
                    </Text>
                    {/* Country line hidden — US only app */}
                  </div>
